...
drug_sim_top10_file = "../mydata/drug/drug_sim_top10.pt"
drug_sim_file = "../mydata/drug/drug_sim.pt"
...
drug_cell_sim_file = "../mydata/pair/drug_cell_sim.pt"
drug_cell_sim_matrix_txt = "../mydata/pair/drug_cell_sim_matrix.txt"
drug_cell_sim_top100_index_file = "../mydata/pair/drug_cell_sim_top100_index.pt"

drug_cell_label_file = "../mydata/pair/drug_response.csv"
...
def main():
    ...
    drug_j = (drug_cell_sim_index // 428).long()
    cell_j = (drug_cell_sim_index % 428).long()
