...
cell_RNAseq_file="./mydata/cell_line/exp_process.csv"
cell_copynumber_file = "./mydata/cell_line/cn_process.csv"
...
def main():
    ...
    RNAseq_feature = pd.read_csv(cell_RNAseq_file, sep=',', header=None, index_col=[0], skiprows=1)
    copynumber_feature = pd.read_csv(cell_copynumber_file, sep=',', header=None, index_col=[0], skiprows=1)
