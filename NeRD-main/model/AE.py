...
def load_data():
    ...
    copynumber = read_cell_line_copynumber('../mydata/cell_line/cnv_489.csv', cell_line_dict)
...
def train(train_data, test_data, data_all):
    ...
    for epoch in range(EPOCH):
        ...
        if test_loss < best_loss:
            ...
            pickle.dump(res.data.numpy(), open('../mydata/cell_line/512dim_copynumber.pkl', 'wb'))
